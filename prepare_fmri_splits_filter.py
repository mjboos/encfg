...
subj_preprocessed_path = 'PreProcessed/dct_{}.pkl'.format(subj)
#subj_preprocessed_path = 'PreProcessed/test_18.pkl'
s1ds = load(spenc_dir + subj_preprocessed_path)
...
fmri_data = np.delete(s1ds, idx_borders, axis=0)
...
for i, (_, split) in enumerate(voxel_kfold):
    dump(fmri_data[:, split],
         '/home/data/scratch/mboos/prepro/fmri_dct_subj_{}_split_{}.pkl'.format(subj, i),
         compress=3)
