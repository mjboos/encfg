...
patches = load(spenc_dir+'MaThe/'+\
                      'transformed_data/sparse_patches_H100.pkl')
...
# shape of TR samples
# note: column ordering is now oldest --> newest in steps of 100
patches = np.reshape(patches, (-1, 100*20))
...
dump(patches,
     spenc_dir+'MaThe/prepro/H100BSC_stimuli_subj_{}.pkl'.format(subj))
